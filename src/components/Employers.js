    ...
    <div>
      ...
      <div class="relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
          <p className="text-4xl md:text-6xl font-Georgia text-center md:text-left">Build your career with</p>
          ...
          <p className="text-lg md:text-xl font-Georgia text-center md:text-left mb-4">
      ...
      <p className='font-Georgia text-4xl text-white p-10'>EMPLOYERS</p>
      </div>
    
      <div className="mx-5 mt-10">
        <p className="text-4xl my-4 font-Georgia">A Passion for Healthcare Staffing. Measurable Results.</p>
        <p className="font-Georgia">Morgans Med Staffing, leading healthcare recruiters nationwide,
        ...
        <div className="flex-wrap mt-10">
          ...
          <div className="px-4 sm:px-6 md:px-6">
            ...
            <p className="font-Georgia">Serving doctor’s offices, clinics, hospitals, patient health centers, and diagnostic imaging centers nationwide:</p>
            <div>
            ...
            <div className="mt-10">
              <p className='text-3xl font-Georgia my-4'>Bring Morgans Med Staffing professionals onto your team today!</p>
              <p className="font-Georgia">Email us  info@morgansmedstaffing.com</p>
            </div>
          </div>
