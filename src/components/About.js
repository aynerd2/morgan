    ...
    <div>
      <div class="relative">
        ...
        <div class="absolute inset-0 flex flex-col justify-center items-center text-white">
          <p class="text-4xl md:text-6xl font-Georgia text-center md:text-left">Improving Healthcare Nationwide</p>
          <hr class="w-2/3 md:w-2/5 border-black border-t-2 my-4" />

          <p class="text-lg md:text-xl font-Georgia text-center md:text-left mb-4">
      ...
      <p className='font-Georgia text-4xl text-white p-10'>ABOUT</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 mt-10 mx-5">
        <div className="md:col-span-1">
          <p className="font-Georgia text-2xl my-2">Our Expertise Makes More Possible</p>
          ...
          <div className="mx-10">
            ...
            <div className="sm:flex">
              <div className="">
                <p className="text-2xl font-bold font-Georgia mt-5">Mission</p>
                <p className="font-Georgia">
            ...
            <div className="mb-4">
              <p className="text-2xl font-bold font-Georgia mt-5">Vision</p>
              <p className="font-Georgia">Morgans Med Staffing  is committed to being a nationwide resource in
